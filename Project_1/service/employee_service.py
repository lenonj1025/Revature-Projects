...
class EmployeeService:
    ...
    #     if len(employee_object.username) < 6 or len(employee_object.username) > 20:
    ...
    #
    #     else:
    #         added_new_employee = self.employee_dao.add_employee(employee_object)
    #         return added_new_employee.to_dict()
